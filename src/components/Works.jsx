...
const  ProjectCard = ({ index, name, description, tags, image, source_code_link, site_url }) => {
  return (
        ...
        speed: 450
            ...
            <div className='relative w-full h-[230px]'>
              ...
              <div className='absolute inset-0 flex justify-end  m-3 card-img_hover'>
                <div onClick={() => window.open(source_code_link, "_blank")} className='black-gradient  w-10 h-10  m-1 rounded-full flex flex-center justify-center items-center cursor-pointer ' >
                  <img src={github} alt='github' className="w-1/2 h-1/2 object-contain" />
                </div><div onClick={() => window.open(site_url, "_blank")} className='black-gradient w-10 h-10 m-1 rounded-full flex flex-center justify-center items-center cursor-pointer' >
                  <img src={web} alt='github' className="w-1/2 h-1/2 object-contain" />
                </div>
              </div>
            </div>
            <div className='mt-5'>
